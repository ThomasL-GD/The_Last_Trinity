...
public class CameraMovement : MonoBehaviour
{
    ...
    [SerializeField][Range(-5, 5)] [Tooltip("The offset of the camera on the rail")] private float m_offsetValue = -1f; //Value de l'offset de la caméra sur le rail de la dolly
    ...
    [SerializeField][Range(0, 3)] [Tooltip("The spped at which the camera moves when the player use the appropriate input")] private float m_lookSpeed = 0f; //Vitesse de déplacement du look sur le côté
    [SerializeField][Range(0, 6)] [Tooltip("The spped at which the camera moves when the player let go the appropriate input")] private float m_returnSpeed = 0f; //Vitesse de déplacement du retour de la caméra
    private float m_globalOffset = -1f; //Vitesse de déplacement du retour de la caméra
