...
public class CameraMovement : MonoBehaviour
{
    ...
    [SerializeField][Range(-5, 5)] [Tooltip("The offset of the camera on the rail")] private float m_offsetValue = 0f; //Value de l'offset de la caméra sur le rail de la dolly
